((typeof self !== 'undefined' ? self : this)["webpackJsonpxthon"] = (typeof self !== 'undefined' ? self : this)["webpackJsonpxthon"] || []).push([[26,57,58],{
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_style_resources_loader_lib_index_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FundraiserUpdates_vue_vue_type_style_index_0_id_3ace88f1_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("2246");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_style_resources_loader_lib_index_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FundraiserUpdates_vue_vue_type_style_index_0_id_3ace88f1_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_style_resources_loader_lib_index_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FundraiserUpdates_vue_vue_type_style_index_0_id_3ace88f1_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_style_resources_loader_lib_index_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FundraiserUpdates_vue_vue_type_style_index_0_id_3ace88f1_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"b756519c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/fundraiser/FundraiserUpdates.vue?vue&type=template&id=3ace88f1&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"updates__wrapper"},_vm._l((_vm.updates),function(update,index){return _c('div',{staticClass:"update__wrapper",class:{'current': update.id === _vm.currentId},attrs:{"id":("update_" + (update.id))}},[_c('div',{staticClass:"update__fullname"},[_c('span',{staticClass:"update__fullname-name"},[_vm._v("Update # "+_vm._s(_vm.count - index))])]),_c('div',{staticClass:"update__timestamp"},[_vm._v(_vm._s(_vm._f("formattedDate")(update.timestamp)))]),(update.content.length > _vm.maxchar)?_c('div',{staticClass:"update__content"},[_c('transition',{attrs:{"name":"fade"}},[(!_vm.showFullUpdate[index])?_c('div',[_c('span',{domProps:{"innerHTML":_vm._s(_vm.excerpt(update.content))}}),_c('span',[_vm._v("... "),_c('a',{on:{"click":function($event){_vm.toggleIndex(index)}}},[_vm._v("Show more")])])]):_c('div',{staticClass:"update__content"},[_c('div',{domProps:{"innerHTML":_vm._s(update.content)}}),_c('span',[_c('a',{on:{"click":function($event){_vm.toggleIndex(index)}}},[_vm._v("Show less")])])])])],1):_c('div',{staticClass:"update__content",domProps:{"innerHTML":_vm._s(update.content)}}),_c('ShareDonateToolbar',{attrs:{"allowComment":false,"url-params":("update_id=" + (update.id)),"text":update.content,"fundraiser-id":_vm.fundraiserId,"update-id":update.id,"trigger":"fundraiser/lower/updates","via":"Volunteerathon","title":"Share this update"}})],1)}))}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/fundraiser/FundraiserUpdates.vue?vue&type=template&id=3ace88f1&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/fundraiser/FundraiserUpdates.vue?vue&type=script&lang=js&
...
/* harmony default export */ var FundraiserUpdatesvue_type_script_lang_js_ = ({
  data: function data() {
    return {
      showFullUpdate: {}
    };
  ...
  methods: {
    ...
    toggleIndex: function toggleIndex(index) {
      if (!this.showFullUpdate[index]) {
        external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(this.showFullUpdate, index, true);
      } else {
        external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(this.showFullUpdate, index, false);
      }
    },
    openShareBox: function openShareBox(update) {
      alert("".concat(window.location.origin).concat(window.location.pathname, "?update_id=").concat(update.id));
    }
  }
});
// CONCATENATED MODULE: ./src/components/fundraiser/FundraiserUpdates.vue?vue&type=script&lang=js&
 /* harmony default export */ var fundraiser_FundraiserUpdatesvue_type_script_lang_js_ = (FundraiserUpdatesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/fundraiser/FundraiserUpdates.vue?vue&type=style&index=0&id=3ace88f1&scoped=true&lang=scss&
var FundraiserUpdatesvue_type_style_index_0_id_3ace88f1_scoped_true_lang_scss_ = __webpack_require__("20de");

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/fundraiser/FundraiserUpdates.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  fundraiser_FundraiserUpdatesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
component.options.__file = "FundraiserUpdates.vue"
/* harmony default export */ var FundraiserUpdates = __webpack_exports__["default"] = (component.exports);
